...
def get_actions_mapper(data_dir_path: str, use_full=False) -> Dict[int, str]:
    """
    ...
    if use_full:
        full = "_full"
    with open(f"{data_dir_path}/reverse_action_mapping{full}.pkl", "rb") as f:
        return pickle.load(f)


def get_objects_mapper(data_dir_path: str, use_full=False) -> Dict[int, Dict[int, str]]:
    """
    ...
    if use_full:
        full = "_full"
    with open(f"{data_dir_path}/reverse_object_mapping{full}.pkl", "rb") as f:
